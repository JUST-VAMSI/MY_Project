...
<body class="text-center">
    <h1 class="start">Sign up</h1>
        <pre><p class="hide">Already an user? Please <a href="login.php" name="log" class="text-primary">login</a>
        <?php
 ...
 ?>
    ...
    <pre><p class="sma">Already an user? Please <a href="login.php" name="log" class="text-primary">login</a>
<?php
    if(isset($_GET['exists']))
    {
        $g=$_GET['exists'];
